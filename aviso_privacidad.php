...
<head>
    <title>Aviso de Privacidad - Póliza de Rentas</title>
                ...
                <div class="container">
                    <div class="row wow fadeInUp" data-wow-delay=".2s">
                        <div class="col-lg-12">
                            ...
                            <h3 class="dorado mt-4">Privacidad de los Datos Personales</h3>
                            ...
                            <h3 class="dorado mt-4">Responsabilidad de las Opiniones Vertidas</h3>
                            ...
                            <h3 class="dorado mt-4">Seguridad de su Información Personal</h3>
                            ...
                            <p><strong class="dorado">Su información personal será utilizada de manera confidencial para los siguientes fines:</strong></p>
                            <ul>
                                <li><strong class="dorado">En caso de inquilinos, sean personas físicas o morales, así como obligados solidarios y/o fiadores:</strong> para la evaluación de su perfil, para investigar su historial crediticio, legal, así como para elaborar y enviar un reporte al propietario del inmueble y/o el agente inmobiliario responsable de su proceso de arrendamiento, para llevar a cabo el servicio de intermediación inmobiliaria en la formalización de la renta de inmuebles.</li>
                                <li><strong class="dorado">En caso de propietarios, sean personas físicas o morales:</strong> para integrar el expediente relativo a la póliza jurídica o económica que se otorgue y de la cual sea beneficiario(a), así como para la elaboración del contrato de arrendamiento, y en su caso, para elaborar cualquier documento relacionado con alguna gestión extrajudicial o judicial.</li>
                                <li><strong class="dorado">En caso de agentes o agencias inmobiliarias, sean personas físicas o morales:</strong> para crear registros de afiliación a nuestras herramientas de gestión de pólizas, previo consentimiento, así como para la asignación de expedientes relacionados con pólizas de protección jurídica a fin de que puedan dar seguimiento a la gestión de las mismas, así como para acceder a sorteos mensuales por colocación.</li>
                            </ul>

                            <p><strong class="dorado">Para las finalidades antes mencionadas, le requerimos algunos datos entre los que se encuentran:</strong></p>
                            <ul>
                            ...
                            <h3 class="dorado mt-4">Uso de la Información</h3>
                            ...
                            <h3 class="dorado mt-4">Uso de los Cookies</h3>
                            ...
                            <h3 class="dorado mt-4">Transferencia de Datos</h3>
                            ...
                            <p><strong class="dorado">Cualquiera de las responsables podrá efectuar transferencias de datos personales, además de los supuestos antes mencionados, de la siguiente manera:</strong></p>
                            <ul>
                            ...
                            <h3 class="dorado mt-4">Derechos ARCO</h3>
                            ...
                            <h3 class="dorado mt-4">Limitación de Uso y Divulgación de Información</h3>
                            ...
                            <p class="text-end"><em>Última actualización: 15/08/2024</em></p>
                        </div>
                    </div>
                </div>
            </section>

                        ...
                        <div class="col-lg-12">
                            <div class="row gx-4">
                                <div class="col-lg-8 col-md-6 mb10">
                                    <img src="images/limitaciones.jpeg" alt="limitaciones" width="150%" class="img-fluid">
                                    ...
                                    <p class="wow fadeInUp">El rol de los asesores inmobiliarios será fundamental en la <b>orientación y facilitación del registro digital de contratos</b>. Este nuevo proceso requerirá documentación adicional que será detallada una vez que se establezca la normativa específica por parte del gobierno de la Ciudad de México.
                                        Los especialistas en arrendamiento inmobiliario, como Póliza de Rentas, jugarán un papel clave en esta orientación, ya que parte de sus servicios consiste en brindar capacitación gratuita a agentes y agencias inmobiliarias sobre la redacción de contratos y preparación para firma de estos, así como las consecuencias legales derivadas de las obligaciones y derechos de arrendadores y arrendatarios, y la atención de incidencias o incumplimientos relacionados.
                                    </p>
                                    ...
                                    <p>La documentación específica se conocerá cuando se determine el mecanismo de registro, pero se espera que los agentes inmobiliarios faciliten el cumplimiento de esta nueva obligación para sus clientes.
                                        Para Póliza de Rentas resulta necesario concientizar a las partes sobre la información y documentación necesaria para generar un contrato de arrendamiento, misma que, con independencia de la existencia del nuevo registro digital, básicamente debería ser la siguiente:
                                    </p>
                                    <ul>
                                    ...
                                    <p>El registro será obligatorio para todos los contratos de arrendamiento, incluyendo los que se encuentren en curso, el cual deberá realizarse en un plazo no mayor de 90 días a partir de la entrada en vigor del mecanismo de registro, que como se ha mencionado, deberá quedar establecido dentro de los 30 días siguientes a la fecha en que se publique el decreto de reforma en la Gaceta Oficial de la Ciudad de México. <br>
                                        No obstante, el plazo para la inscripción de nuevos contratos de arrendamiento será establecido por el Gobierno de la Ciudad de México con posterioridad.
                                    </p>
                                    ...
                                    <p class="float-end" ALIGN="end"><b>Agosto de 2024</b> <br>

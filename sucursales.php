...
<head>
    ...
    <style>
        .map-container {
            width: 100%;
            /* Opcional: ajusta el ancho del contenedor */
            max-width: 600px;
        ...
        #MX-TAB:hover,
        #MX-YUC:hover {
            fill: rgb(211, 185, 134) !important;
        }
    </style>
                                        ...
                                        <div class="container">
                                            <div class="row gx-5 align-items-center">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a class="btn-main mb10" href="contact.html">Ubica tu sucursal</a>
                                                    <a class="btn-main mb10" href="contact.html">Contrata ahora
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="map-container d-flex justify-content-center">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-6">
                                ...
                                <svg id="mexico-map" xmlns:mapsvg="http://mapsvg.com" viewBox="00 00 800 1100" class="d-block d-sm-none" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg" mapsvg:geoViewBox="-118.369112 32.716750 -86.725536 14.531518" width="792.41846" height="497.54324">
                                    ...
                                    <!-- <image xlink:href="images/favicon.svg" x="60" y="-90" width="30" height="300" />
                                    <image xlink:href="images/favicon.svg" x="280" y="-50" width="30" height="300" /> -->
                                </svg>

                                <svg id="mexico-map" xmlns:mapsvg="http://mapsvg.com" viewBox="00 00 1100 600" class="d-none d-lg-block" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg" mapsvg:geoViewBox="-118.369112 32.716750 -86.725536 14.531518" width="792.41846" height="497.54324">
                                ...
                                <!-- Más paths para otros estados -->

                                <script>
                                    document.querySelectorAll('#mexico-map path').forEach(function(path) {
                                        path.addEventListener('click', function() {
                                            var estadoId = path.getAttribute('data-estado');
                                            mostrarEstado(estadoId);
                                            var estadosDiv = document.getElementById('estados');
                                            estadosDiv.style.display = 'block';
                                            if (estadosDiv) {
                                                estadosDiv.scrollIntoView({
                                                    behavior: 'smooth'
                                                });
                                            }
                                            console.log(path.id)
                                    ...
                                    function mostrarEstado(estadoId) {
                                        ...
                                        var elementosMostrar = document.querySelectorAll('[data-estado="' + estadoId + '"]');
                ...
                <script>
                    document.addEventListener("DOMContentLoaded", function() {
                        ...
                        function mostrarEstado(sucursales) {
                            ...
                            // Mostrar los elementos correspondientes al estado seleccionado
                            var elementosMostrar = document.querySelectorAll('[data-estado="' + sucursales + '"]');
                            elementosMostrar.forEach(function(elemento) {
                                elemento.style.display = 'block';
                            });
                        }
                ...
                <div class="container">
                    <div class="row sequence">
                            ...
                            <div class="de-item wow jarallax">
                                <div class="d-overlay">
                                    ...
                                    <div class="d-text">
                                        ...
                                        <a class="btn-main btn-fullwidth btn-white" href="study-case-single.html">Read
                                            Story</a>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-12 d-flex justify-content-center">
                            <a class="btn-main mt-5" href="contact.html">Ver más artículos</a>
                        </div>
                    </div>
                </div>
            </section>

                ...
                <div class="swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide" data-jarallax-element="150">
                            <div class="swiper-inner" data-bgimage="url(images/services/convenio-prevencion-conflictos/convenio-prevencion-conflictos-01.jpg)">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-12 wow fadeInLeft">
                        <div class="padding60 sm-padding40 rounded-30 bg-color h-100 text-light">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h2 class="mb20 wow fadeInUp" data-wow-delay=".2s">Beneficios del contrato de Transacción</h2>
